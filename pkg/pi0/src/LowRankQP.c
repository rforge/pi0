...
#include <math.h>
#include <stdio.h>
#include <stdlib.h> /*added by Long Qu to avoid the warning about the free() function*/
#include <time.h>
    ...
    double *dual, double *comp, double *gap, double *term )
{
    ...
    {
	/********** this is comment out by Long Qu in the R package pi0 to avoid excessive printing
